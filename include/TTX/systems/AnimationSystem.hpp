...
#ifndef AnimationSYSTEM_INC
#define AnimationSYSTEM_INC


/// The AnimationSystem for managing all Instance rendering in a game
class AnimationSystem : public ISystem
{
   public:
       ...
       */
      AnimationSystem(IActionState& theState);
