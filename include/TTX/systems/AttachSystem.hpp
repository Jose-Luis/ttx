...
#ifndef AttachSYSTEM_INC
#define AttachSYSTEM_INC


/// The AttachSystem for managing all Instance rendering in a game
class AttachSystem : public ISystem
{
public:
   /**
    * AttachSystem Constructor.
    * @param[in] theApp is the current GQE app.
    */
   AttachSystem(IActionState& theState, b2World& theWorld);
