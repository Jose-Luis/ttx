...
#ifndef ENTITYLISTENERSYSTEM_INC
#define ENTITYLISTENERSYSTEM_INC


/// The EntityListenerSystem for managing all father-child relations between entities  in a game

class EntityListenerSystem : public ISystem
{
public:
   /**
    * EntityListenerSystem Constructor.
    * @param[in] theApp is the current GQE app.
    */
   EntityListenerSystem(IActionState& theState);

   /**
    * ISystem Destructor.
    */
   virtual ~EntityListenerSystem();
