...
#ifndef FAMILYSYSTEM_INC
#define FAMILYSYSTEM_INC


/// The FamilySystem for managing all father-child relations between entities  in a game

class FamilySystem : public ISystem
{
public:
   /**
    * FamilySystem Constructor.
    * @param[in] theApp is the current GQE app.
    */
   FamilySystem(IActionState& theState);

   /**
    * ISystem Destructor.
    */
   virtual ~FamilySystem();
