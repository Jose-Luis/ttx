// =====================================================================================
// 
//       Filename:  B2ObjectDefSystem.hpp
// 
//    Description:  
// 
//        Version:  1.0
...
#ifndef  B2OBJECTDEFSYSTEM_INC
#define  B2OBJECTDEFSYSTEM_INC
...
class B2ObjectDefSystem: public GQE::ISystem
{
   public:

      B2ObjectDefSystem (GQE::IApp& theApp);                             // constructor

      virtual ~B2ObjectDefSystem ();
      ...
      void addToWorld(b2World* theWorld);
   protected:
      /**
...
#endif //  ----- #ifndef B2OBJECTDEFSYSTEM_INC  -----
