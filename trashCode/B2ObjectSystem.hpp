...
#ifndef  B2OBJECTSYSTEM_INC
#define  B2OBJECTSYSTEM_INC
...
class B2ObjectSystem: public GQE::ISystem
{
public:

   B2ObjectSystem (GQE::IApp& theApp);                             // constructor

   virtual ~B2ObjectSystem ();
...
#endif //  ----- #ifndef B2OBJECTSYSTEM_INC  -----
